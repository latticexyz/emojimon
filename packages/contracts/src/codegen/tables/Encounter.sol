...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("Encounter")))
);
ResourceId constant EncounterTableId = _tableId;
...
library Encounter {
  ...
  function decodeStatic(
    ...
    monster = (Bytes.slice32(_blob, 1));

    catchAttempts = (uint256(Bytes.slice32(_blob, 33)));
  }
