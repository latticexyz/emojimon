...
library Obstruction {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Obstruction", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004f62737472756374696f6e0000000000);
